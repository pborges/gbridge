...
type OnOffCommand func(ctx gbridge.Context, state bool) proto.DeviceError
...
func (t OnOffCommand) Execute(ctx gbridge.Context, args map[string]interface{}) proto.DeviceError {
